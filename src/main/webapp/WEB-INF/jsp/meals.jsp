    ...
    <div class="container">
        ...
        <div class="card border-dark text-center">
            ...
            <div class="card-footer text-right">
                <button class="btn btn-secondary" onclick="clearFilter()"><span class="fa fa-remove"></span><spring:message code="common.cancel"/></button>
                <button class="btn btn-primary" onClick="filterMeal()"><span class="fa fa-filter"></span><spring:message code="meal.filter"/></button>
            </div>
        </div>
        <br>
        <button class="btn btn-primary" onClick="add()"><span class="fa fa-plus"></span><spring:message code="meal.add"/></button>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="dateTime" name="dateTime" placeholder="<spring:message code="meal.dateTime"/>">
                    </div>
